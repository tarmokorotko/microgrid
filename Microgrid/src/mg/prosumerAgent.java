...
/**
 * This class acts as a server that handles communication with Matlab. 
 * @author tarmokorotko
...
public class prosumerAgent extends Agent
{
	...
	protected void setup() 
	{
		...
		//String msgContent = "Test,18.6,14.2,1,2.4";
		...
		//String answer = callMatlab(msgContent);
		//out.flush();
	...
	/**
	 * A behaviour sending periodiacal TCP messages
	 */
	class sendPeriodical extends TickerBehaviour
	{
		...
		protected void onTick() {
			...
			String msgContent = String.valueOf(cal.get(Calendar.HOUR))+" "+ 
					...
					"\n";	
			System.out.println(getLocalName() + ": Message sent to Matlab: " + msgContent);
			//callMatlab1(String.valueOf(msgContent));
			//out.flush();
	...
	class CommWithMatlab extends SimpleBehaviour
	{
		...
		private static final long serialVersionUID = 9286361912L;
